...
describe User do
	...
	describe "when email format is invalid" do
		it "should be invalid" do
			addresses = %w[user@foo,com user_at_foo.org example.user@foo. foo@bar_bax.com foo@bar+baz.com]
	...
	describe "blog association" do
		...
		describe "status" do
			...
			before do
				...
				3.times { followed_user.blogs.create!(content: "Fuck that shit and fuck all!") } 
			end
			...
			its(:feed) do
				followed_user.blogs.each do |blog|
					should include(blog)
				end
			end
		end
